...
st.write("A high-level overview of your trading performance, automatically updated from your journal.")

# --- Load Data ---
perf_df = load_performance_data()

if perf_df.empty:
    st.info("Your trade journal is empty. Log some trades to see your performance metrics here.")
    st.stop()
