...
from utils.spaces_manager import get_spaces_client, get_spaces_credentials_status
...
class TestSpacesManager:
    ...
    def test_get_spaces_credentials_status_all_missing(self):
        ...
        with (
            patch("utils.spaces_manager.SPACES_ACCESS_KEY_ID", None),
    ...
    def test_get_spaces_credentials_status_all_present(self):
        ...
        with (
            patch("utils.spaces_manager.SPACES_ACCESS_KEY_ID", "test_key"),
